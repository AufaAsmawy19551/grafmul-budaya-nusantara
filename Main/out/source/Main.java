/* autogenerated by Processing revision 1282 on 2022-07-12 */
...
Person orang = new Person(0, 0, 3, 0xFFEB984E);
...
public class Person  {
  ...
  public void lihat(String arah, int numberOfFrame) 
  {
    int frameCount = 0;
    if (frameCount < numberOfFrame) {
      if (arah == "atas") {
        this.mata[0] = 0;
        this.mata[1] = -5;
